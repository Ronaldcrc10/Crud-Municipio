    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('municipios.update', ['municipio' => $municipio->muni_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id" name="id" disabled value="{{ $municipio->muni_codi }}">
                <div class="form-text">ID Municipio</div>
            </div>

            <!-- Campo de nombre Municipio -->
            <div class="mb-3">
                <label for="name" class="form-label">Nombre del municipio</label>
                <input type="text" class="form-control" id="name" name="name" required value="{{ $municipio->muni_nomb }}" placeholder="Escriba el nombre del municipio">
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="Departamento" name="code" required>
                    ...
                    @foreach ($departamentos as $departamento)
                        <option value="{{ $departamento->depa_codi }}" {{ $departamento->depa_codi == $departamento->depa_codi ? 'selected' : '' }}>
